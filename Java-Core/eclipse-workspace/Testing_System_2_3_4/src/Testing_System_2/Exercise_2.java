...
public class Exercise_2 {
	public static void main(String[] args) {
		...
		//question 1
		int a = 5;
		System.err.printf("%d",a);
		System.err.println();
		
		//question 2
			int b = 100000000;
			System.err.printf("%,d",b);
			System.err.println();
		
		//question 3
			float c = 5.545432524f;
			System.err.printf("%.3f",c);
			System.err.println();

		//question 4
			String d = "Vũ Tiến Long";
			System.err.println("Tên tôi là "+d+" và tôi đang độc thân");
		
		//question 5
			String e = "dd-MM-yyyy HH:mm:ss";
			SimpleDateFormat date = new SimpleDateFormat(e);
			String date2 = date.format(new Date());
			System.err.println(date2);
			
		//question 6
			for (int i = 0; i < accountOfGroup1.length; i++) {
				System.err.println("\nCâu 6: ");
				System.err.println("\nEmail         |"+ accountOfGroup1[i].email);
				System.err.println(("FullName      |"+ accountOfGroup1[i].fullName));
				System.err.println("Tên phòng ban |"+ accountOfGroup1[i].departments.departmentName );
			}

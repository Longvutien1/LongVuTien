	...
	public static void main(String[] args) {
		// create department
				...
				// create account
					...
					account2.fullName = "Vũ Trọng Hoàng";
				...
				// 1 account co nhieu group
					...
					Group[] groupAccount2 = { group1, group3 };
				...
				// create question
					...
					question1.createDate = LocalDate.of(2021, 4, 6);
					...
					question2.createDate = LocalDate.of(2021, 1, 2);
					...
					question3.createDate = LocalDate.of(2021, 2, 2);
				...
				// create Exam
					...
					exam1.examID = 1;
					exam1.code = 1;
					exam1.title = "Đề thi THPT Quốc gia 2018";	
					exam1.duration = 90;
					exam1.createID = account1;
					exam1.categoryID = categoryQuestion1;
					exam1.createDate = LocalDate.of(2021, 1, 1);
					
					Exam exam2 = new Exam();
					exam2.examID = 2;
					exam2.code = 2;
					exam2.title = "Đề thi THPT Quốc gia 2019";	
					exam2.duration = 90;
					exam2.createID = account2;
					exam2.categoryID = categoryQuestion2;
					exam2.createDate = LocalDate.of(2021, 2, 1);
				
					Exam exam3 = new Exam();
					exam3.examID = 3;
					exam3.code = 3;
					exam3.title = "Đề thi THPT Quốc gia 2020";	
					exam3.duration = 90;
					exam3.createID = account1;
					exam3.categoryID = categoryQuestion3;
					exam3.createDate = LocalDate.of(2021, 1, 1);
					...
					System.err.println("Department 1: ");
					System.err.println("ID: " +demartment1.departmentID);
					System.err.println("Name: "+ demartment1.departmentName);
					
					
					System.err.println("\n------Position---------");
					System.err.println("Position 1: ");
					System.err.println("ID: "+position1.positionID);
					System.err.println(("Name: "+ position1.positionName));
					
					
					System.err.println("\n-----Account---------");
					System.err.println("Account 1: ");
					System.err.println("ID: "+ account1.accountID);
					System.err.println("Email: "+account1.email);
					System.err.println("User Name: "+account1.userName);
					System.err.println("Full name: "+account1.fullName);
					System.err.println("Department name: "+account1.departments.departmentName);
					System.err.println("Position name: "+account1.positions.positionName);
					System.err.println("Create Date: "+account1.createDate);
					
					
					
					System.err.println("\n------Group---------");
					System.err.println("Group 1: ");
					System.err.println("ID : "+group1.groupID);
					System.err.println("GroupName: "+group1.groupName);
					System.err.println(("CreatorID: "+ group1.CreatorID.fullName));
					System.err.println("CreateDate: "+group1.createDate);
					
					
					System.err.println("\n------TypeQuestion---------");
					System.err.println("TypeQuestion 1:  ");
					System.err.println("ID 1: "+typeQuestion1.typeID);
					System.err.println("TypeName: "+typeQuestion1.typeName);
					
					
					System.err.println("\n------CategoryQuestion---------");
					System.err.println("CategoryQuestion 1: ");
					System.err.println("ID : "+categoryQuestion1.categoryID);
					System.err.println("CategoryName: "+categoryQuestion1.categoryName);
					
					
					System.err.println("\n------Question---------");
					System.err.println("QuestionID 1: ");
					System.err.println("ID : "+question1.questionID);
					System.err.println("Content: "+question1.content);
					System.err.println("Category name: "+ question1.categoryID.categoryName);
					System.err.println("Type name: "+ question1.typeID.typeName);
					System.err.println("Creator Name: "+ question1.creatorID.fullName);
					System.err.println("CreateDate: "+ question1.createDate);
					
					
					
					System.err.println("\n------Answer---------");
					System.err.println("Answer 1: ");
					System.err.println("ID : "+answer1.answerID);
					System.err.println("Content: "+answer1.content);
					System.err.println("Question name: "+ answer1.questionID.content);
					System.err.println("isCorrect : "+ answer1.isCorrect);
					
					
					System.err.println("\n------Exam---------");
					System.err.println("Exam 1: ");
					System.err.println("ID : "+exam1.examID);
					System.err.println("Code: "+exam1.code);
					System.err.println("Title : "+ exam1.title);
					System.err.println("Category name : "+ exam1.categoryID.categoryName);
					System.err.println("Duration: "+exam1.duration);
					System.err.println("Creator name : "+ exam1.createID.fullName);
					System.err.println("CreateDate  : "+ exam1.createDate);
